...
export class ListButton {
    constructor(focusService, navigationService, wrapperRef, _zone) {
    ...
    subscribeComponentBlurredEvent() {
        this._zone.runOutsideAngular(() => {
            ...
            this.componentBlurredSubscription = this.wrapperBlurred.pipe(merge(this.navigationService.tab, this.documentClick), filter(() => this._isFocused))
    ...
    enterHanlder() { } // tslint:disable-line
    unsubscribeEvents() {
        if (!isDocumentAvailable()) {
            return;
        }
